...
import br.com.gocharg.dto.ocpp.json.response.ClearCacheResponse;
...
@Component
public class ClearCacheResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    ClearCacheResponse response = (ClearCacheResponse) ocppRequest.getPayload();
