...
import br.com.gocharg.dto.ocpp.json.response.UpdateFirmwareResponse;
...
@Component
public class UpdateFirmwareResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    UpdateFirmwareResponse response = (UpdateFirmwareResponse) ocppRequest.getPayload();
