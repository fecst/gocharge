...
import br.com.gocharg.dto.ocpp.json.response.GetCompositeScheduleResponse;
...
@Component
public class GetCompositeScheduleResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    GetCompositeScheduleResponse response = (GetCompositeScheduleResponse) ocppRequest.getPayload();
