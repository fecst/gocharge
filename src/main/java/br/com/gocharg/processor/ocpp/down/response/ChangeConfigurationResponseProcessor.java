...
import br.com.gocharg.dto.ocpp.json.response.ChangeConfigurationResponse;
...
@Component
public class ChangeConfigurationResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    ChangeConfigurationResponse response = (ChangeConfigurationResponse) ocppRequest.getPayload();
