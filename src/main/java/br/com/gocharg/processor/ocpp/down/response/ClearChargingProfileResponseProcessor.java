...
import br.com.gocharg.dto.ocpp.json.response.ClearChargingProfileResponse;
...
@Component
public class ClearChargingProfileResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    ClearChargingProfileResponse response = (ClearChargingProfileResponse) ocppRequest.getPayload();
