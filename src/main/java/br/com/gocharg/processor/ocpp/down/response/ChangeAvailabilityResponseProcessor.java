...
import br.com.gocharg.dto.ocpp.json.response.ChangeAvailabilityResponse;
...
@Component
public class ChangeAvailabilityResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    ChangeAvailabilityResponse response = (ChangeAvailabilityResponse) ocppRequest.getPayload();
