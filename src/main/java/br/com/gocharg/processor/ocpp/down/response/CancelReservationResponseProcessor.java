...
@Component
public class CancelReservationResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    CancelReservationResponse response = (CancelReservationResponse) ocppRequest.getPayload();
