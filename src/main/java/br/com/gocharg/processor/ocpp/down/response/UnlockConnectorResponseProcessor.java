...
import br.com.gocharg.dto.ocpp.json.response.UnlockConnectorResponse;
...
@Component
public class UnlockConnectorResponseProcessor implements CommandProcessor {
  ...
  public Object process(CommandContext context) {
    ...
    UnlockConnectorResponse response = (UnlockConnectorResponse) ocppRequest.getPayload();
